...
1. [Download and Install Perl](http://openkore.com/index.php/How_to_run_OpenKore#Perl) (you can run start.exe if you use windows)
...
2. [Older News](https://github.com/OpenKore/openkore/commits/master/README.txt)
