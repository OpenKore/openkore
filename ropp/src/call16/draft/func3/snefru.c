...
#define	CHUNK_SIZE (INPUT_BLOCK_SIZE - 4)
...
word32 standardSBoxes[16][256]= {
            ...
            {  /* Start of S Box 4  */
               ...
               0xE48F25F4L,0x14EA3C96L,0x7D83FA8BL,0x199276EBL,0x00 1DAC0L,
...
void Hash512 (word32 output[4], word32 input[INPUT_BLOCK_SIZE]) {
