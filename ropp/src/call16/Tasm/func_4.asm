...
L509396:
    ...
    MOV     ESI,EDI
    MOV     EAX,ECX
    LEA     EDI,[DWORD EBP-044h]
    SHR     ECX,2
    REP     MOVS [DWORD ES:EDI],[DWORD ESI]
    MOV     ECX,EAX
    AND     ECX,3
    REP     MOVS [BYTE ES:EDI],[BYTE ESI]
    MOV     ESI,[DWORD EBP+010h]
L5093B4:
...
proc func4
    ...
    MOV     ECX,0Fh
    XOR     EAX,EAX
    LEA     EDI,[DWORD EBP-054h]
    MOV     [DWORD EBP-058h],0
    LEA     EDX,[DWORD EBP-058h]
    REP     STOS [DWORD ES:EDI]
    MOV     EAX,[DWORD EBP+8]
