...
package Network::Receive::asiaRO::Renewal;

use strict;
use base qw(Network::Receive::asiaRO);
...
sub new {
	...
	my %packets = (
		...
		'0ADD' => ['item_appeared', 'a4 V C a2 v2 C2 v C v', [qw(ID nameID type identified x y subx suby amount show_effect effect_type )]],
