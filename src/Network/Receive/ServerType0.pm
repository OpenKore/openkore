...
sub new {
	...
	$self->{packet_list} = {
		...
		'0AC4' => ['account_server_info', 'x2 a4 a4 a4 a4 a26 C x17 a*', [qw(sessionID accountID sessionID2 lastLoginIP lastLoginTime accountSex serverInfo)]],# new recv for kRO client
	};
