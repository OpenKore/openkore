...
sub new {
	...
	$self->{packet_list} = {
		...
		'02B3' => ['quest_add', 'V C V2 v', [qw(questID active time_start time_expire mission_amount)]],
		'02B4' => ['quest_delete', 'V', [qw(questID)]],
		'02B5' => ['quest_update_mission_hunt', 'v2 a*', [qw(len mission_amount mobInfo)]],		# var len
		...
		'09F8' => ['quest_all_list3', 'v V', [qw(len amount)]],
		'09F9' => ['quest_add', 'V C V2 v', [qw(questID active time_start time_expire mission_amount)]],
		'09FA' => ['quest_update_mission_hunt', 'v2 a*', [qw(len mission_amount mobInfo)]],
