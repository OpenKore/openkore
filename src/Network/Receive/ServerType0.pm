...
sub new {
	...
	$self->{packet_list} = {
		...
		'09F7' => ['homunculus_property', 'Z24 C v20 V2 v2', [qw(name state level hunger intimacy accessory atk matk hit critical def mdef flee aspd hp hp_max sp sp_max exp exp_max points_skill attack_range)]],
