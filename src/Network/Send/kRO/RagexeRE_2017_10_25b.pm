...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2017_10_25b;

use strict;
use base qw(Network::Send::kRO::RagexeRE_2017_10_18a);
...
#		use = $key1 $key3 $key2
#	$self->cryptKeys(0x165C565C,0x565C565C,0x565C565C);
