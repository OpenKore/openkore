...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2018_02_07b;

use strict;
use base qw(Network::Send::kRO::RagexeRE_2018_01_24b);
...
sub new {
	...
	my %packets = (
		...
		'0881' => ['friend_request', 'a*', [qw(username)]],# len 26
