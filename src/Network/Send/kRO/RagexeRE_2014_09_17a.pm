...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2014_09_17a;
...
sub new {
	...
	my %packets = (
		...
		'0838' => ['buy_bulk_openShop', 'a4 c a*', [qw(limitZeny result itemInfo)]], #Selling store
		...
		'0956' => ['item_list_res', 'v V2 a*', [qw(len type action itemInfo)]],
