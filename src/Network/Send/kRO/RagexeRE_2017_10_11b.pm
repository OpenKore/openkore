...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2017_10_11b;

use strict;
use base qw(Network::Send::kRO::RagexeRE_2017_10_02c);
...
sub new {
	...
	my %packets = (
		...
		'087B' => ['friend_request', 'a*', [qw(username)]],# len 26
		'0882' => ['homunculus_command', 'v C', [qw(commandType commandID)]],
...
#		use = $key1 $key3 $key2
#	$self->cryptKeys(0x4F121B3E,0x19896C11,0x12670E17);
