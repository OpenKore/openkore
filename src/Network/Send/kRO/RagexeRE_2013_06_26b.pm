...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2013_06_26b;
...
sub new {
	...
	my %packets = (
		...
		'08AB' => ['friend_request', 'a*', [qw(username)]],# len 26
		'0960' => ['homunculus_command', 'v C', [qw(commandType commandID)]],
		'0952' => ['item_drop', 'a2 v', [qw(ID amount)]],
		...
		'0895' => ['party_join_request_by_name', 'Z24', [qw(partyName)]],
		'083C' => ['skill_use', 'v2 a4', [qw(lv skillID targetID)]],
		'0438' => ['skill_use_location', 'v4', [qw(lv skillID x y)]],
		'0921' => ['storage_item_add', 'a2 V', [qw(ID amount)]],
		'0817' => ['storage_item_remove', 'a2 V', [qw(ID amount)]],
		'0930' => ['storage_password'],
		'035F' => ['sync', 'V', [qw(time)]],
	...
	my %handlers = qw(
		...
		storage_item_add 0921
		storage_item_remove 0817
		storage_password 0930
		sync 035F
...
#	$self->cryptKeys(0x38F453EF, 0X65BD6668, 0x6A040FD8);
