...
package Network::Send::kRO::RagexeRE_2017_02_08;

use strict;
use base 'Network::Send::kRO::RagexeRE_2016_12_14';
...
sub new {
	...
	my %packets = (
		...
		'0367' => ['item_list_res', 'v V2 a*', [qw(len type action itemInfo)]],
		...
		'08AC' => ['storage_item_add', 'v V', [qw(index amount)]],
