...
########################################################################
#bysctnightcore
package Network::Send::kRO::RagexeRE_2017_11_15a;

use strict;
use base qw(Network::Send::kRO::RagexeRE_2017_11_01b);
...
sub new {
	...
	my %packets = (
		...
		'0802' => ['friend_request', 'a*', [qw(username)]],# len 26
		'0958' => ['homunculus_command', 'v C', [qw(commandType commandID)]],
		'0365' => ['item_drop', 'a2 v', [qw(ID amount)]],
		'086F' => ['item_list_window_selected', 'v V V a*', [qw(len type act itemInfo)]],
		'0926' => ['item_take', 'a4', [qw(ID)]],
		'0360' => ['map_login', 'a4 a4 a4 V C', [qw(accountID charID sessionID tick sex)]],
		'095A' => ['party_join_request_by_name', 'Z24', [qw(partyName)]],
		'083C' => ['skill_use', 'v2 a4', [qw(lv skillID targetID)]],
		'0438' => ['skill_use_location', 'v4', [qw(lv skillID x y)]],
		'088B' => ['storage_item_add', 'a2 V', [qw(ID amount)]],
		'087E' => ['storage_item_remove', 'a2 V', [qw(ID amount)]],
		'0898' => ['storage_password'],
		'035F' => ['sync', 'V', [qw(time)]],
	...
	my %handlers = qw(
		...
		item_drop 0365
		item_list_window_selected 086F
		item_take 0926
		map_login 0360
		party_join_request_by_name 095A
		skill_use 083C
		skill_use_location 0438
		storage_item_add 088B
		storage_item_remove 087E
		storage_password 0898
		sync 035F
