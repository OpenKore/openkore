...
sub charSelectScreen {
	...
	if ($mode eq "create") {
		while (1) {
			my $message;
			if ( $messageSender->{char_create_version} == 0x0A39 || $config{'charCreateVersion'} == 4) {
				$message
