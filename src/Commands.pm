...
sub initHandlers {
	register(
		...
		['party', [
			...
			[T("share shareitem <flag>"), T("sets party ITEM sharing to even if flag is 1, individual take if 0")],
			[T("share sharediv  <flag>"), T("sets party ITEM  PICKUP sharing to even if flag is 1, individual take if 0")],
			[T("share shareauto"), T("set party EXP sharing auto by AI")],
