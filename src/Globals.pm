...
our %EXPORT_TAGS = (
	...
	network => [qw($remote_socket $net $messageSender $charServer $conState $conState_tries $encryptVal $ipc $bus $masterServer $lastSwitch $packetParser $clientPacketHandler $bytesSent $incomingMessages $outgoingClientMessages $enc_val1 $enc_val2 $captcha_state $poseidon_query_port $poseidon_query_ip)],
...
our $enc_val1;
our $enc_val2;
our $poseidon_query_port;
our $poseidon_query_ip;
