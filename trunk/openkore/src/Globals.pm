...
our %EXPORT_TAGS = (
	...
	network => [qw($net $charServer $conState $conState_tries $encryptVal $ipc $lastPacketTime $masterServer $msg $msgOut $lastswitch $packetParser $bytesSent $bytesReceived)],
