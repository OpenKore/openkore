...
sub cmdEquipment {
	message(swrite(
	"    / \\   topHead:   @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{topHead})?$char->{equipment}{topHead}{name}:''],
	"    | |   midHead:   @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{midHead})?$char->{equipment}{midHead}{name}:''],
	"    \\ /   lowHead:   @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{lowHead})?$char->{equipment}{lowHead}{name}:''],
	"     |    robe:      @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{robe})?$char->{equipment}{robe}{name}:''],
	"   / | \\  armor:     @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{armor})?$char->{equipment}{armor}{name}:''],
	"  /  |  \\ leftHand:  @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{leftHand})?$char->{equipment}{leftHand}{name}:''],
	" /   |   \\rightHand: @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{rightHand})?$char->{equipment}{rightHand}{name}:''],
	"     |    leftAcc:   @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{leftAccessory})?$char->{equipment}{leftAccessory}{name}:''],
	"    / \\   rightAcc:  @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{rightAccessory})?$char->{equipment}{rightAccessory}{name}:''],
	"   /   \\  arrow:     @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{arrow})?$char->{equipment}{arrow}{name}:''],
	"  /     \\ shoes:     @<<<<<<<<<<<<<<<<<<<<<<<<<<<",
	[($char->{equipment}{shoes})?$char->{equipment}{shoes}{name}:''],
	" /       \\",
	[]
	));
}
