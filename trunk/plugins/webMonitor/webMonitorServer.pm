...
sub request {
	...
	%keywords =	(
		...
		'characterLeftHand' => $char->{equipment}{leftHand}{name},
		'characterRightHand' => $char->{equipment}{rightHand}{name},
		'characterTopHead' => $char->{equipment}{topHead}{name},
		'characterMidHead' => $char->{equipment}{midHead}{name},
		'characterLowHead' => $char->{equipment}{lowHead}{name},
		'characterRobe' => $char->{equipment}{robe}{name},
		'characterArmor' => $char->{equipment}{armor}{name},
		'characterShoes' => $char->{equipment}{shoes}{name},
		'characterLeftAccessory' => $char->{equipment}{leftAccessory}{name},
		'characterRightAccessory' => $char->{equipment}{rightAccessory}{name},
		'characterArrow' => $char->{equipment}{arrow}{name},
