 ...
 # Copyright (C) 2009 Technology (credits to Sonder Köksal for discovering the algorithm and key in his antisex project)
...
sub encrypt {
	...
	$len = (int($len / 16) + 1) * 16; # set length to the multiple of blocksize 16 >= then len
