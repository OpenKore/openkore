...
sub onClientData {
	...
	if (($switch eq '01DB') || ($switch eq '0204')) { # client sends login packet 0204 packet thanks to elhazard
		...
		my $data = $accountID .
			pack("C*",0x6b,0x00,0x82,0x00,0x00,0x01,0x00,0x00,
			0x00,0x64,0x00,0x00,0x00,0x00,0x00,0x14,0xA3,0x84,0x00,0x00,0x00,0x00,0x00,0x00,0x00) .
			# kRO length = 0x82
			# iRO length = 0x6A
		...
		my $data;
		$data .= pack("C*",0x2C,0x02,0x3F,0xE9,0x00,0x00,0xC8,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00) .
		...
		$data .= pack("C*",0x9E,0x00,0x77,0x4A,0x00,0x00,0x,0x04,0x01,0x34,0x00,0x6F,0x00,0x03,0x0C,0x01,0x00);
		# '009E' => ['item_appeared', 'a4 v1 x1 v1 v1 x2 v1', [qw(ID type x y amount)]],

		$data .= pack("C*",0x0F,0x01,0xA4,0x04,0x01,0x00,0x00,0x00,0x00,0x00,0x09,0x00,0x00,0x00,0x01,0x00);
		$data .= pack("C*",0x4E,0x56,0x5F,0x42,0x41,0x53,0x49,0x43,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x16,0x00,0x00,0x00,0x00,0x00,0x0A);
		$data .= pack("C*",0x00,0x00,0x00,0x01,0x00,0x41,0x4C,0x5F,0x44,0x50,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x17,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x0A,0x00,0x00,0x00,0x01,0x00,0x41,0x4C,0x5F,0x44,0x45,0x4D);
		$data .= pack("C*",0x4F,0x4E,0x42,0x41,0x4E,0x45,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x18,0x00,0x04,0x00,0x00,0x00,0x01,0x00,0x0A,0x00,0x0A,0x00,0x41);
		$data .= pack("C*",0x4C,0x5F,0x52,0x55,0x57,0x41,0x43,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x19,0x00,0x02,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x0A,0x00,0x09,0x00,0x41,0x4C,0x5F,0x50,0x4E,0x45,0x55,0x4D,0x41,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1A,0x00,0x04);
		$data .= pack("C*",0x00,0x00,0x00,0x01,0x00,0x0A,0x00,0x01,0x00,0x41,0x4C,0x5F,0x54,0x45,0x4C,0x45);
		$data .= pack("C*",0x50,0x4F,0x52,0x54,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x01,0x1B,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x26,0x00,0x09,0x00,0x41,0x4C);
		$data .= pack("C*",0x5F,0x57,0x41,0x52,0x50,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x1C,0x00,0x10,0x00,0x00,0x00,0x07,0x00,0x1F);
		$data .= pack("C*",0x00,0x09,0x00,0x41,0x4C,0x5F,0x48,0x45,0x41,0x4C,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x1D,0x00,0x10,0x00);
		$data .= pack("C*",0x00,0x00,0x0A,0x00,0x2D,0x00,0x09,0x00,0x41,0x4C,0x5F,0x49,0x4E,0x43,0x41,0x47);
		$data .= pack("C*",0x49,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x1E,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x0D,0x00,0x09,0x00,0x41,0x4C,0x5F);
		$data .= pack("C*",0x44,0x45,0x43,0x41,0x47,0x49,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x01,0x1F,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x0A,0x00);
		$data .= pack("C*",0x01,0x00,0x41,0x4C,0x5F,0x48,0x4F,0x4C,0x59,0x57,0x41,0x54,0x45,0x52,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x20,0x00,0x04,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x23,0x00,0x01,0x00,0x41,0x4C,0x5F,0x43,0x52,0x55,0x43,0x49,0x53);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01);
		$data .= pack("C*",0x21,0x00,0x04,0x00,0x00,0x00,0x00,0x00,0x14,0x00,0x01,0x00,0x41,0x4C,0x5F,0x41);
		$data .= pack("C*",0x4E,0x47,0x45,0x4C,0x55,0x53,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x01,0x22,0x00,0x10,0x00,0x00,0x00,0x0A,0x00,0x40,0x00,0x09);
		$data .= pack("C*",0x00,0x41,0x4C,0x5F,0x42,0x4C,0x45,0x53,0x53,0x49,0x4E,0x47,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x23,0x00,0x10,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x10,0x00,0x09,0x00,0x41,0x4C,0x5F,0x43,0x55,0x52,0x45,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x35);
		$data .= pack("C*",0x00,0x10,0x00,0x00,0x00,0x01,0x00,0x0A,0x00,0x09,0x00,0x54,0x46,0x5F,0x44,0x45);
		$data .= pack("C*",0x54,0x4F,0x58,0x49,0x46,0x59,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x8E,0x00,0x04,0x00,0x00,0x00,0x01,0x00,0x03,0x00,0x01,0x00);
		$data .= pack("C*",0x4E,0x56,0x5F,0x46,0x49,0x52,0x53,0x54,0x41,0x49,0x44,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0x01,0x00,0x00,0x00,0x00,0x05);
		$data .= pack("C*",0x00,0x00,0x00,0x01,0x00,0x4D,0x4F,0x5F,0x49,0x52,0x4F,0x4E,0x48,0x41,0x4E,0x44);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x04,0x01);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x4D,0x4F,0x5F,0x53,0x50,0x49);
		$data .= pack("C*",0x52,0x49,0x54,0x53,0x52,0x45,0x43,0x4F,0x56,0x45,0x52,0x59,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x05,0x01,0x04,0x00,0x00,0x00,0x05,0x00,0x08,0x00,0x01,0x00,0x4D);
		$data .= pack("C*",0x4F,0x5F,0x43,0x41,0x4C,0x4C,0x53,0x50,0x49,0x52,0x49,0x54,0x53,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x01,0x10,0x00,0x00,0x00,0x01,0x00);
		$data .= pack("C*",0x05,0x00,0x09,0x00,0x4D,0x4F,0x5F,0x41,0x42,0x53,0x4F,0x52,0x42,0x53,0x50,0x49);
		$data .= pack("C*",0x52,0x49,0x54,0x53,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x07,0x01,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x01,0x00,0x4D,0x4F,0x5F,0x54,0x52,0x49,0x50);
		$data .= pack("C*",0x4C,0x45,0x41,0x54,0x54,0x41,0x43,0x4B,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x01,0x08,0x01,0x02,0x00,0x00,0x00,0x00,0x00,0x0E,0x00,0x12,0x00,0x4D,0x4F);
		$data .= pack("C*",0x5F,0x42,0x4F,0x44,0x59,0x52,0x45,0x4C,0x4F,0x43,0x41,0x54,0x49,0x4F,0x4E,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x09,0x01,0x00,0x00,0x00,0x00,0x05,0x00,0x00);
		$data .= pack("C*",0x00,0x01,0x00,0x4D,0x4F,0x5F,0x44,0x4F,0x44,0x47,0x45,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x0A,0x01,0x01,0x00);
		$data .= pack("C*",0x00,0x00,0x03,0x00,0x11,0x00,0x02,0x00,0x4D,0x4F,0x5F,0x49,0x4E,0x56,0x45,0x53);
		$data .= pack("C*",0x54,0x49,0x47,0x41,0x54,0x45,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
		$data .= pack("C*",0x01,0x0B,0x01,0x01,0x00,0x00,0x00,0x03,0x00,0x0A,0x00,0x09,0x00,0x4D,0x4F,0x5F);
		$data .= pack("C*",0x46,0x49,0x4E,0x47,0x45,0x52,0x4F,0x46,0x46,0x45,0x4E,0x53,0x49,0x56,0x45,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x01,0x0C,0x01,0x04,0x00,0x00,0x00,0x00,0x00,0xC8,0x00);
		$data .= pack("C*",0x01,0x00,0x4D,0x4F,0x5F,0x53,0x54,0x45,0x45,0x4C,0x42,0x4F,0x44,0x59,0x00,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x0D,0x01,0x04,0x00,0x00);
		$data .= pack("C*",0x00,0x01,0x00,0x0A,0x00,0x01,0x00,0x4D,0x4F,0x5F,0x42,0x4C,0x41,0x44,0x45,0x53);
		$data .= pack("C*",0x54,0x4F,0x50,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01);
		$data .= pack("C*",0x0E,0x01,0x04,0x00,0x00,0x00,0x03,0x00,0x0F,0x00,0x01,0x00,0x4D,0x4F,0x5F,0x45);
		$data .= pack("C*",0x58,0x50,0x4C,0x4F,0x53,0x49,0x4F,0x4E,0x53,0x50,0x49,0x52,0x49,0x54,0x53,0x00);
		$data .= pack("C*",0x00,0x00,0x00,0x00,0x01,0x0F,0x01,0x01,0x00,0x00,0x00,0x01,0x00,0x01,0x00,0x02);
		$data .= pack("C*",0x00,0x4D,0x4F,0x5F,0x45,0x58,0x54,0x52,0x45,0x4D,0x49,0x54,0x59,0x46,0x49,0x53);
		$data .= pack("C*",0x54,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x10,0x01,0x04,0x00,0x00,0x00);
		$data .= pack("C*",0x05,0x00,0x0F,0x00,0x02,0x00,0x4D,0x4F,0x5F,0x43,0x48,0x41,0x49,0x4E,0x43,0x4F);
		$data .= pack("C*",0x4D,0x42,0x4F,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x11);
		$data .= pack("C*",0x01,0x04,0x00,0x00,0x00,0x05,0x00,0x0F,0x00,0x02,0x00,0x4D,0x4F,0x5F,0x43,0x4F);
		$data .= pack("C*",0x4D,0x42,0x4F,0x46,0x49,0x4E,0x49,0x53,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
