...
sub new {
	...
	my %handlers = qw(
		actor_look_at 0838
		party_join_request_by_name 0923
		master_login 02B0
		map_login 022D
...
sub sendStoragePassword {
	...
	my $msg;
	if ($type == 3) {
		$msg = pack("v v", 0x957, $type).$pass.pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8");
	} elsif ($type == 2) {
		$msg = pack("v v", 0x957, $type).pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8").$pass;
	} else {
...
sub PrepareKeys()
{
	...
	# M
	$enc_val3 = Math::BigInt->new('0x778601F');
	# A
