...
sub new {
	...
	my %packets = (
		...
		'092C' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
	);
...
sub sendStoragePassword {
	...
	my $msg;
	if ($type == 3) {
		$msg = pack("v v", 0x08A9, $type).$pass.pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8");
	} elsif ($type == 2) {
		$msg = pack("v v", 0x08A9, $type).pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8").$pass;
	} else {
...
{
		# K
		$enc_val1 = Math::BigInt->new('0x0d3d5371');
		# M
		$enc_val2 = Math::BigInt->new('0x75a223e6');
		# A
		$enc_val3 = Math::BigInt->new('0x72f80740');
}
