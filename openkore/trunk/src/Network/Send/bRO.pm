...
sub new {
	...
	my %handlers = qw(
		...
		item_take 0882
		item_drop 0364
		storage_item_add 0361
		storage_item_remove 0438
		skill_use_location 0365
		actor_info_request 096A
		map_login 0917
		party_join_request_by_name 0883
		homunculus_command 08A6
		master_login 02B0
		party_setting 07D7
...
sub sendStoragePassword {
	...
	my $msg;
	if ($type == 3) {
		$msg = pack("v v", 0x08A0, $type).$pass.pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8");
	} elsif ($type == 2) {
		$msg = pack("v v", 0x08A0, $type).pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8").$pass;
	} else {
...
{
		# K
		$enc_val1 = Math::BigInt->new('0x4275098f');
		# M
		$enc_val2 = Math::BigInt->new('0x3a0a6b0f');
		# A
		$enc_val3 = Math::BigInt->new('0x1adb21d4');
}
