...
sub new {
	...
	my %packets = (
		...
		'094D' => ['party_join_request_by_name', 'Z24', [qw(partyName)]],
...
{
		# K
		$enc_val1 = Math::BigInt->new('0x01ae43b9');
		# M
		$enc_val2 = Math::BigInt->new('0x26793378');
		# A
		$enc_val3 = Math::BigInt->new('0x18a368c1');
}
