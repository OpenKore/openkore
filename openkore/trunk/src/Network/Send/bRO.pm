...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'092D' => ['actor_look_at', 'v C', [qw(head body)]],
		'0944' => ['item_take', 'a4', [qw(ID)]],
		...
		'08A6' => ['party_join_request_by_name', 'Z24', [qw(partyName)]],
		'0815' => ['homunculus_command', 'v C', [qw(commandType, commandID)]],
	);
	...
	my %handlers = qw(
		...
		item_take 0944
		item_drop 087D
		storage_item_add 0888
		storage_item_remove 087C
		skill_use_location 0438
		actor_info_request 096A
		map_login 088D
		party_join_request_by_name 08A6
		homunculus_command 0815
		master_login 02B0
		party_setting 07D7
...
sub sendStoragePassword {
	...
	my $msg;
	if ($type == 3) {
		$msg = pack("v v", 0x0883, $type).$pass.pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8");
	} elsif ($type == 2) {
		$msg = pack("v v", 0x0883, $type).pack("H*", "EC62E539BB6BBC811A60C06FACCB7EC8").$pass;
	} else {
...
{
		# K
		$enc_val1 = Math::BigInt->new('0x5ffc7c68');
		# M
		$enc_val2 = Math::BigInt->new('0x7f4f6320');
		# A
		$enc_val3 = Math::BigInt->new('0x13e268e1');
}
