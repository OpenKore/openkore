...
sub new {
	...
	$self->{packet_list}{'007C'} = ['actor_display', 'x1 a4 v14 C2 a3 C2', [qw(ID walk_speed param1 param2 param3 hair_style weapon lowhead type shield tophead midhead hair_color clothes_color head_dir karma sex coords unknown1 unknown2)]];
