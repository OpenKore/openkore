...
sub new {
	...
	my %packets = (
		'007C' => ['actor_display',	'C a4 v14 C2 a3 C4',	[qw(object_type ID walk_speed opt1 opt2 option hair_style weapon lowhead type shield tophead midhead hair_color clothes_color head_dir karma sex coords xSize ySize unknown1 unknown2)]], #spawning (eA does not send this for players) # 44
		# 0x02e2,20
		# 0x02e3,22
		# 0x02e4,11
		# 0x02e5,9
