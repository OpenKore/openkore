...
sub new {
	...
	my %packets = (
		...
		'022C' => ['actor_display', 'a4 v3 V v5 V v5 a4 a2 v V C2 a6 C2 v',	[qw(ID walk_speed opt1 opt2 option type hair_style weapon shield lowhead tick tophead midhead hair_color clothes_color head_dir guildID emblemID manner opt3 karma sex coords xSize ySize lv)]], # 64 # walking
	);
