...
our %EXPORT_TAGS = (
	...
	network => [qw($remote_socket $net $messageSender $charServer $conState $conState_tries $encryptVal $ipc $lastPacketTime $masterServer $msg $msgOut $lastswitch $packetParser $bytesSent $bytesReceived)],
