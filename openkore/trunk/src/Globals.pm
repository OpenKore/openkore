...
our %skillsArea;
our %skillsEncore;
our (%statusHandle, %stateHandle, %lookHandle, %statusName);
our %spells_lut;
our %timeout;
our %jobs_lut = (
	0 => 'Novice',
